  ...
  return (
    <div className="relative h-96 overflow-hidden">
      ...
      {banners.map((banner, index) => (
        ...
        >
          <div className="relative h-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
            <div className="text-center text-white px-4">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                {banner.title}
              </h2>
              <p className="text-xl md:text-2xl mb-8">{banner.subtitle}</p>
              <button className="px-8 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition transform hover:scale-105">
                Explore Courses
              </button>
            </div>
          </div>
